...
void drawImage(Context &ctx)
{
    ...
    // Get the location of the u_gammaCorrection uniform variable in the shader program
    if (ctx.rtx.gammaCorrection) {
        ctx.rtx.myGammaCorrection = 1.0f;
    } else {
        ctx.rtx.myGammaCorrection = 0.0f;
    }

    glUniform1f(glGetUniformLocation(ctx.program, "u_gammaCorrection"), ctx.rtx.myGammaCorrection);
...
void showGui(Context &ctx)
{
    ...
    // ...
    if (ImGui::Checkbox("gamma correction", &ctx.rtx.gammaCorrection)) { rt::resetAccumulation(ctx.rtx); }
    if (ImGui::Checkbox("Sphere 1 ", &ctx.rtx.show_s1_metal)) { rt::resetAccumulation(ctx.rtx); }
    if (ImGui::Checkbox("Sphere 2 ", &ctx.rtx.show_s2_metal)) { rt::resetAccumulation(ctx.rtx); }
    if (ImGui::Checkbox("Sphere 3 ", &ctx.rtx.show_s3_metal)) { rt::resetAccumulation(ctx.rtx); }
    if (ImGui::Checkbox("Anti-aliasing", &ctx.rtx.show_aa)) { rt::resetAccumulation(ctx.rtx); }
